...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			<tr><td width="20%">Nama Pimpinan</td><td><b><input type="text" name="kepala" required value="<?php echo $data->kepala; ?>" style="width: 300px" class="form-control"></b></td></tr>
			<tr><td width="20%">NIP Pimpinan</td><td><b><input type="text" name="nip_kepala" required value="<?php echo $data->nip_kepala; ?>" style="width: 300px" class="form-control"></b></td></tr>
