...
if ($mode == "edt" || $mode == "act_edt") {
	...
	$nama_kegiatan			= $datpil->nmkegiatan;
...
<form action="<?php echo base_URL()?>index.php/admin/entry_unitkerjakab/<?php echo $act; ?>/<?php echo $datpil->batas_minggu;; ?>" method="post" accept-charset="utf-8" role="form" enctype="multipart/form-data">
	...
	<div class="col-lg-8">
		...
		<tr>
			...
			Masukkan Realisasi Minggu Ini</td>
		</tr>
		<tr>
